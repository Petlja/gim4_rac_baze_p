...
Свака иоле сложенија веб-апликација укључује неколико различитих фајлова 
(датотека, докумената), па је логична конвенција да се све оне чувају унутар 
једног фолдера (директоријума,  фасцикле) намењеног тој веб-апликацији. 
Направићемо стога фолдер под именом ``01_hello`` и у њему ћемо креирати фајл ``app.py`` следеће садржине. 
