...
серверу саставни део URL-a. На пример, URL може бити следећег облика...:
...
међутим, технике програмирања које сада упознајемо користићемо
...
- Контрола (HTML елемент) ``select`` се користи као падајућа
  ...
  ``option``. Приликом слања података комбинује се атрибут ``name``
