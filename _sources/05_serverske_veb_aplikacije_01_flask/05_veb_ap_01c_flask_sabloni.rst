...
не морате да пишете комплетан програмски код од почетка. Препоручена пракса је да узмете већ 
припремљене примере програмског кода и да га прилагодите на начин на који вам је потребно. 
...
Измењен програмски код може да се види на следећој слици. 

.. image:: ../../_images/flask_20g.png
   :width: 400
   :align: center
 
Након што сачувамо измене, вратимо се у командну линију и поново покренемо Flask апликацију командом ``flask run``. 
 
.. image:: ../../_images/flask_20h.png
   :width: 400
   :align: center
