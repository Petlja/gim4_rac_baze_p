...
податке у HTML страни, док обрада POST захтева уписује податке у базу.
...
функцију која обрађује HTTP захтев који доспе на неку путању могуће је
...
пример, наредним кôдом се постиже да се функција ``login`` позива само
...
одговарају и на GET захтеве). На пример, наредним кôдом се постиже да
