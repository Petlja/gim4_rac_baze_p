...
апсолутној путањи.  Међутим у оквиру HTML шаблона не морамо
унапред знати коју путању ће имати веб-страна у оквиру које ће бити
примењен шаблон. Чак је могуће да се исти шаблон примени у оквиру веб-страна на различитим путањама. Због тога у шаблону не можемо да
...
То би у прегледачу изгледало овако:
...
.. fillintheblank:: flask-static-1
   ...
   библиотеке Flask требало би да се налазе унутар директоријума:
