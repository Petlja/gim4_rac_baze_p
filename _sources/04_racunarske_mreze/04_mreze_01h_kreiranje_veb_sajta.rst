 ...
 **Задатак**
 ...
 `pocetna_slika1.jpg <pocetna_slika1.jpg>`

 `pocetna_slika2.jpg <pocetna_slika2.jpg>`

 `pocetna_slika3.jpg <pocetna_slika3.jpg>`
 ...
 `pocetna_racunarske_mreze.txt <pocetna_racunarske_mreze.txt>`

 `strana2_adrese.txt <strana2_adrese.txt>`

 `strana3_detaljnije_mrezni_slojevi_protokoli.txt <strana3_detaljnije_mrezni_slojevi_protokoli.txt>`
