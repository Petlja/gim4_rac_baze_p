...
- Веома често је потребно осигурати да неко поље формулара није остало
  празно. То се једноставно постиже тиме што се сва поља која су
  обавезна и морају бити попуњена обележе атрибутом ``required``.
...
``customerForm``, па му на основу тога из JavaScript кôда можемо
...
Друга је функција специфична за проверу мејл адресе. У њој се
...
функција за свако поље за унос текста проверава да ли је непразно (односно да ли је у поље унета нека вредност) и
