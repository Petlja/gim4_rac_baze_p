...
Да би наши програми преко АПИ могли да приступају СУБП, обично је потребно да у програм укњучимо посебан модул, 
...
Неки од примера који следе су јако обимни. Имајте у виду да, када правите овакве веб-апликације, не морате да 
пишете комплетан програмски код од почетка. Препоручена пракса је да узмете већ припремљене примере програмског 
кода и да га прилагодите на начин на који вам је потребно.
