...
На почетку проверавамо да ли променљива ``error`` има вредност ``True``
...
промени, потребно је ажурирати и шсаблон ``genres.html``. Ово се сматра
...
идентичног кôда генерално сматра лошом праксом, јер отежава одржавање
...
захтев, користићемо често убудуће, али сада, вежбе ради,
...
На месту које се разликује дефинишемо блок под називом ``content``,
