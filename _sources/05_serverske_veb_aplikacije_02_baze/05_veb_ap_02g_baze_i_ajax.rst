...
Сви досадашњи скриптови су били организовани на традиционални начин --
након што стигне захтев, скрипт на серверској страни формира HTML
...
склопу стране која је тренутно отворена.  Овај начин рада се назива
...
HTML садржај ``innerHTML`` на празну ниску). Након тога обрађујемо
...
изградње URL-а и отварања везе према њему методом ``open``, захтев
