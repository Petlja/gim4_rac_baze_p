...
.. infonote::
   ...
   Овај курс и његови примери су тестирани на *SQLite Studio* верзији 3.3.3. Новије верзије овог програма захтевају од корисника да укључи у базу екстензију под називом *„ICU”* како би могао даље да користи *UNICODE* колациону секвенцу као у примерима, односно, како би програм сортирао ћириличко писмо како треба. То можете урадити тако што отворите *extension manager* алатку SQLite Studio ГКИ-а, кликнете на *icu* и затим штиклирате *Register in all databases* као на следећем снимку екрана.

   .. image:: ../../_images/sqlite_icu.png
      :width: 600
      :align: center
