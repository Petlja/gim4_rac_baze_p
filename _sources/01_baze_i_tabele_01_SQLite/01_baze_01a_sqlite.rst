...
.. infonote:: 
   ...
   Овај курс и примери у њему су тестирани на `SQLite Studio верзији 3.3.3 <https://github.com/pawelsalawa/sqlitestudio/releases/tag/3.3.3>`_. Нове верзије овог програма су донеле измене које су учиниле да одређени примери више не функционишу на исти начин. Из тог разлога је за сада најбоље да овај курс пратите користећи баш ту верзију програма коју можете преузети са следећег линка: https://github.com/pawelsalawa/sqlitestudio/releases/download/3.3.3/sqlitestudio-3.3.3.zip

   Радимо на томе да курс ажурирамо користећи најновију верзију програма или адекватну алтернативу. 
...
.. technicalnote:: Инсталација
   ...
   На следећој адреси је можете преузети *.zip* фајл са овим програмом. 
