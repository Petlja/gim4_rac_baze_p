...
.. technicalnote::
   ...
   Овај курс и његови примери су тестирани на *SQLite Studio* верзији 3.3.3. Новије верзије овог алата захтевају од корисника да сам дефинише *UNICODE* колациону секвенцу како би могао да отвори податке и да осигура да ће ћирилички подаци биди сортирани по азбучном реду. Испод следе кораци како да ову колациону секвенцу дефинишете у новијим верзијама овог алата.

   1. Из горњег менија одаберемо *Tools* а затим опцију *Open collations editor*

      .. image:: ../../_images/open_collatios_editor.jpg
         :width: 600
         :align: center

   2. Као *Collation name* унесемо *UNICODE*, и штиклирамо *Register in all databases*

   3. У одељак *Implementation code* ископирамо и налепимо следећи код:

   .. code::
      
      function UNICODE(str1, str2) {
         return str1.localeCompare(str2);
      }

   4. На крају, кликнемо на зелени штиклир означен на снимку екрана: 

   .. image:: ../../_images/close_collatios_editor.jpg
         :width: 600
         :align: center
